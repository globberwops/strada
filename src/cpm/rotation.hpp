...
inline auto EulerToMatrix(double heading, double pitch, double roll) noexcept -> Matrix3x3 {
...
inline auto ComposeRotations(const Matrix3x3& rot_a, const Matrix3x3& rot_b) noexcept -> Matrix3x3 {
  Matrix3x3 rot_c;
